...
type OptionsTableProps = {
  ...
  editOption: (option: ProductOption) => void;
  createOption: () => void;
  updateOptions: (newOptions: ProductOption[]) => void;
};
...
const OptionsTable = ({
  ...
  const handleAdd = () => {
    ...
    setIsAdding(false);
    setNewOption({ nombre: '', descripcion: '', precio: 0 });
  };
  ...
  const startAdding = () => {
    ...
    <section className="flex justify-center w-full">
      <div className="lg:-mx-8 lg:px-8 -my-2 w-full overflow-x-auto py-2 sm:-mx-6">
        <label
          htmlFor="features"
              ...
              {options?.map((option, index) => (
                <tr key={option.nombre}>
                  ...
                  <td className="whitespace-no-wrap min-w-max border-b border-gray-200 px-4 py-4 text-sm leading-5 text-gray-500">
                    $ {option.precio.toLocaleString("es-ES")}
                  </td>
                ...
                <tr>
                  <td className="whitespace-no-wrap border-b border-gray-200 px-4 py-4">
                    <input
                      ...
                      onChange={(e) =>
                        setNewOption({ ...newOption, nombre: e.target.value })
                      }
                      placeholder="Nombre"
                    ...
                    <input
                      type="text"
                      value={newOption.descripcion}
                      onChange={(e) =>
                        setNewOption({ ...newOption, descripcion: e.target.value })
                      }
                      placeholder="Descripción"
                      className="w-full mt-2 rounded-md border border-gray-300 px-3 py-1 transition duration-150 ease-in-out focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500"
                    />
                  </td>
                  <td className="whitespace-no-wrap min-w-max border-b border-gray-200 px-4 py-4 text-sm leading-5 text-gray-500">
                    <input
                      ...
                      onChange={(e) =>
                        setNewOption({ ...newOption, precio: parseFloat(e.target.value) })
                      }
                      placeholder="Precio"
                      className="w-full rounded-md border border-gray-300 px-3 py-1 transition duration-150 ease-in-out focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500"
                    />
